...
const content = {
  pt: {
    ...
    description: "para sua dor. Construímos agentes de IA adaptáveis, dashboards que guiam decisões e integrações/automações que eliminam tarefas repetitivas. Entregamos ponta a ponta: do diagnóstico à operação rodando — self-hosted ou cloud, conforme o seu contexto.",
  ...
  en: {
    ...
    description: "for your pain points. We build adaptive AI agents, dashboards that guide decisions, and integrations/automations that eliminate repetitive tasks. We deliver end-to-end: from diagnosis to running operations — self-hosted or cloud, according to your context.",
